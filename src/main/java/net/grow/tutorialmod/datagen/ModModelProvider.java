...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.SPEED);

        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.MAGIC_BLOCK);

        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.DARK_BLOCK_CORNER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.DARK_BLOCK_LINE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.DARK_BLOCK_PURE);
